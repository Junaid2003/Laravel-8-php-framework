...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Urdu Web Dashboard</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; Copyright Junaid Alam
          <a class="text-primary" href="http://www.jamiaqasmia.com/" target="_blank">Junaid</a>.
        </p>
      </div>
    </div>
</body>
